...
<!-- Mirrored from designreset.com/cork/html/vertical-light-menu/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 01 Jun 2023 03:20:46 GMT -->
<head>
    <meta charset="utf-8">
  ...
  @include('backend.layout.backinclude.backheader_link')
...
<body class="layout-boxed">
  ...
  @include('backend.layout.backinclude.backheader')
  ...
  @include('backend.layout.backinclude.backsidebar')
        ...
        <div id="content" class="main-content">
            ...
            <!--  BEGIN FOOTER  -->
        @include('backend.layout.backinclude.backfooter')
  ...
  @include('backend.layout.backinclude.backfooter_link')
    <!-- BEGIN PAGE LEVEL PLUGINS/CUSTOM SCRIPTS -->

</body>

<!-- Mirrored from designreset.com/cork/html/vertical-light-menu/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 01 Jun 2023 03:21:29 GMT -->
</html>